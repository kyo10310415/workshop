...
export default function Login() {
  ...
  // Already logged in? Redirect to workshops
  useEffect(() => {
    if (user) {
      navigate('/workshops');
    }
      ...
      <div className="bg-white p-12 rounded-3xl shadow-2xl w-full max-w-md">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-sm text-gray-600 space-y-2">
            <p className="font-semibold text-gray-800 mb-3">テストアカウント:</p>
            <div className="bg-blue-50 p-3 rounded-lg">
              <p className="font-mono text-xs">
                <span className="font-semibold">管理者:</span> admin@example.com / admin123
              </p>
            </div>
            <div className="bg-green-50 p-3 rounded-lg">
              <p className="font-mono text-xs">
                <span className="font-semibold">ユーザー:</span> user@example.com / user123
              </p>
            </div>
          </div>
        </div>
